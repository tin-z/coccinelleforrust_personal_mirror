...
\frame[containsverbatim]{\frametitle{An alternate semantic patch}
...
\node [xshift=4.4cm,yshift=-4.0cm] at (current page.center)
{
...
\frame{\frametitle{Some more Coccinelle future features}
\begin{itemize}
\setlength{\itemsep}{2mm}
